...
<a name="defaults"></a>`defaults`| Similar to the top-level `defaults` but applies only to this task.
<a name="defines"></a>`defines`| Similar to the top-level `defines` but applies only to this task.
...
<a name="role_defaults"></a>`role_defaults`| Similar to the top-level `role_defaults` but applies only to this task.
<a name="role_defines"></a>`role_defines`| Similar to the top-level `role_defines` but applies only to this task.
