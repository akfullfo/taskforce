...
- Fix issue when no roles are present. [Andrew Fullford]

- Allow IncompleteRead error when stop control is issued. [Andrew
  Fullford]

- Allow roles to have assoicated values which will be added to the
  context. [Andrew Fullford]

- Allow count to be specified by a context variable. [Andrew Fullford]

- Switch to travis_latest group. [Andrew Fullford]

- Merge branch 'master' of github.com:akfullfo/taskforce. [Andrew
  Fullford]

- Testing travis group edge. [Andrew Fullford]

0.5.0 (2017-11-14)
------------------

- Release 0.5.0. [Andrew Fullford]
